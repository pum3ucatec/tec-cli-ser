...
namespace e3_csharp.Controllers
{
    public class ClassroomController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Estado")] Classroom classroom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Estado")] Classroom classroom)
        {
            if (id != classroom.Id)
            {
                return NotFound();
