...
namespace e3_csharp.Controllers
{
    public class CareerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Description,Status")] Career career)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Description,Status")] Career career)
        {
            if (id != career.ID)
            {
                return NotFound();
